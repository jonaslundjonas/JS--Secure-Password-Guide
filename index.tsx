...
// Fix: Cast elements to their specific types to access properties like 'disabled', 'checked', and 'value'.
const dom = {
    ...
    makeReadableBtn: document.getElementById('make-readable-btn') as HTMLButtonElement,
    ...
    uppercaseCheckbox: document.getElementById('uppercase-checkbox') as HTMLInputElement,
...
function handleOptionsChange() {
    ...
    dom.lengthLabel.textContent = String(state.options.length);
    renderStrength();
}
